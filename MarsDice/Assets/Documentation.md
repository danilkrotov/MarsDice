...
| **DamageDeal** | Турели **`MTurret`**: сначала фиксация **цели** (игрок выбирает при нескольких противниках), затем **`ReplenishConsumedDice`** и раскладка кубиков, бросок; при успехе — урон цели через **`TakeDamage()`**; снятие кубика с **`RemoveDice`** и **`Destroy`** корня слота. |
